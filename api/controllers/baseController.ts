...
export default class BaseControllerr<T extends BaseService<BaseModel>>  {
  
  protected service: typeof BaseService<BaseModel> & { new(): T };
  protected test: string;

  constructor(service: typeof BaseService<BaseModel> & { new(): T }, test: string) {
